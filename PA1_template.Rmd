...
```{r creating data subset, echo = TRUE}
...
```{r creating data set for number of steps histogram, echo = TRUE}
...
```{r creating aggregate number of steps histogram, echo = TRUE}
...
```{r showing histogram data mean and median, echo = TRUE}
...
```{r creating time series plot for average daily activity, echo = TRUE}
...
```{r finding the interval with highest average steps, echo = TRUE}
...
```{r summary of data to look at NAs, echo = TRUE}
summary(monitor_df)
...
```{r filling in NA values with median values, echo = TRUE}
...
```{r checking there are no more NAs, echo = TRUE}
...
```{r creating a histogram of the modified data set, echo = TRUE}
## Loading ggplot to create the histogram
...
```{r looking at the new mean and median values, echo = TRUE}
...
```{r identifying weekdays and weekends by date, echo=TRUE}
...
```{r arranging plots of weekday versus weekend activity patterns, echo=TRUE}
